...
class Track():
    def __init__(self):
        ...
        pixels = self.track_image.get_data("RGBA", pitch)  # getting pixels as groups of 'RGBA' bytes
    ...
    def is_road(self, x, y):
        if x < 0 or x > 960 or y < 0 or y > 540:
            return False
        return self.map_matrix[int(y)][int(x)] == 1  # return true if the coordinate represent the road
